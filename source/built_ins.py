...
class NamespaceQT(CodeNamespace):
    ...
    definitions: dict[str, Definition] = {
        ...
        "tapr": Definition(TagType.BUILT_IN, 6),
        "push": Definition(TagType.BUILT_IN, 7),
        "pop": Definition(TagType.BUILT_IN, 8),
        "call": Definition(TagType.BUILT_IN, 9),
        "return": Definition(TagType.BUILT_IN, 10),
        "jump": Definition(TagType.BUILT_IN, 11),
        "jumpc": Definition(TagType.BUILT_IN, 12),
        "clf": Definition(TagType.BUILT_IN, 13),
        "and": Definition(TagType.BUILT_IN, 16),
        "or": Definition(TagType.BUILT_IN, 17),
        "xor": Definition(TagType.BUILT_IN, 18),
